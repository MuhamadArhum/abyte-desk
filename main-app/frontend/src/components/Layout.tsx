  ...
  const menuStructure: MenuItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { icon: Calendar,    label: 'Daily Attendance',  path: '/daily-attendance',     moduleKey: 'hr.attendance' },
        ...
        { icon: BookOpen,    label: 'Employee Ledger',   path: '/employee-ledger',  moduleKey: 'hr.reports' },
        ...
        { icon: FileText,    label: 'Salary Sheet',      path: '/salary-sheet',     moduleKey: 'hr.payroll' },
        { icon: Receipt,     label: 'Salary Slips',      path: '/salary-voucher',   moduleKey: 'hr.payroll' },
        { icon: DollarSign,  label: 'Payroll Processing',path: '/payroll',          moduleKey: 'hr.payroll' },
        { icon: TrendingUp,  label: 'Salary Increment',  path: '/increments',       moduleKey: 'hr.payroll' },
        // ── HR MANAGEMENT ──
        ...
        { icon: Calendar,    label: 'Holidays',          path: '/holidays',         moduleKey: 'hr.attendance' },
        // ── CONFIGURATION ──
        { icon: Settings,    label: 'CONFIGURATION',     isSection: true } as any,
        { icon: Building2,   label: 'Departments',       path: '/departments',      moduleKey: 'hr.staff' },
        { icon: Sliders,     label: 'Salary Components', path: '/salary-components',moduleKey: 'hr.salary-components' },
        { icon: Star,        label: 'Appraisals',        path: '/appraisals',       moduleKey: 'hr.staff' },
        { icon: LogIn,       label: 'Exit Management',   path: '/exit-management',  moduleKey: 'hr.staff' },
      ]
    },
    {
      icon: DollarSign,
      ...
      children: [
        ...
        { icon: Receipt, label: 'Cash Receipt Voucher (CRV)', path: '/receipt-vouchers', moduleKey: 'accounts.payment-vouchers' },
        { icon: Book, label: 'Account Ledger', path: '/general-ledger', moduleKey: 'accounts.ledger' },
        { icon: Scale, label: 'Trial Balance', path: '/trial-balance', moduleKey: 'accounts.ledger' },
        { icon: LayoutGrid, label: 'Trial Balance 6 Col', path: '/trial-balance-6col', moduleKey: 'accounts.ledger' },
        { icon: TrendingUp, label: 'Profit & Loss', path: '/profit-loss', moduleKey: 'accounts.ledger' },
        { icon: FileBarChart, label: 'Balance Sheet', path: '/balance-sheet', moduleKey: 'accounts.ledger' },
        { icon: Building2, label: 'Bank Accounts', path: '/bank-accounts', moduleKey: 'accounts.bank' },
